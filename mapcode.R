...
#working directory
setwd("C:/Users/04616598/Box Sync/Documents/Data Sciance/GitHub/MSDS6306/Beers And Breweries/")
...
library(car)
str(Beers)
scatterplot.matrix(~ABV+IBU+Ounces | Style, Beers,
                   main="Beer Styles")
